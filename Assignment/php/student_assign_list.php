<?php
    ...
    $sql = "SELECT *,courses.courseName FROM assignments INNER JOIN courses ON assignments.courseId = courses.courseId
    WHERE programId = ?";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$studentRow->studentProgramId]); 
    $assignmentRows = $stmt->fetchAll(PDO::FETCH_OBJ);
                                ...
                                <?php
                                    ...
                                    foreach($assignmentRows as $assignmentRow){
                                      echo '<tr>';
                                        ...
                                        echo '</td>';
                                        echo '<td>';
                                          echo '<a href="student_view_assign.php?assignmentId='.$assignmentRow->assignmentId.'" class="btn btn-primary btn-sm">View</a>';
                                          //echo '<a href="#" class="btn btn-warning btn-sm" style="margin:1px">Edit</a>';
                                        echo '</td>';
                                      echo '</tr>';
                                      $s_no ++;
                                    }
