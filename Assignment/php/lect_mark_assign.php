...
$sql = "SELECT worked_assign_files.*, students.studentFirstName,studentMiddleName,studentLastName FROM worked_assign_files  INNER JOIN students  
ON students.studentId = worked_assign_files.studentId WHERE 
worked_assign_files.studentId = $studentId AND worked_assign_files.assignmentId=$assignmentId";
$stmt = $pdo->query($sql);
$workedAssignmentRow = $stmt->fetch(PDO::FETCH_ASSOC);
//var_dump($workedAssignmentRow);
//die;
                ...
                <div style="width: 85%;" class="course-info bg-white">
                  <div style="margin-left: 5%; display: flex; flex-direction: column; justify-content: center; min-height: 70vh;">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-3">
                          <h4 style="color:#1c2a33">Student's Name :</h4>
                        </div>
                        <div class="col-9">
                          <span style="font-size: 16px; color:#1c2a33">
                            <?php
                              echo $workedAssignmentRow['studentFirstName'];
                            ?>
                          </span>
                        </div>
                      </div>
                      <div class="row mt-2">
                        ...
                        <div class="col-9">
                          <span style="font-size: 16px; color:#1c2a33">
                            <?php
                              echo $workedAssignmentRow['workedAssignFile'];
                            ?>
                          </span>
                        </div>
                      </div>
